 ...
 * Saves go out one at a time, in order (`lib/progress/queue.ts`). Inside
 * `LessonPlayerProvider` (PR-7) the YouTube player is also shared with the
 * tutor and check, and the completion milestone is announced to them.
 */
