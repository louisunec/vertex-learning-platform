...
import {explanationTaskPublishBlockReason} from './actions/explanation-task-publish'
...
const PUBLISH_GATES: Record<string, PublishBlockReason> = {
  ...
  explanationTask: explanationTaskPublishBlockReason,
}
 ...
 * rejected ones are kept for audit. An explanation task is archived, not
 * removed, because learner explanations refer to its id and version.
 */
const PERMANENT_TYPES = new Set(['concept', 'conceptPrerequisite', 'explanationTask'])
